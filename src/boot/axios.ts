...
api.interceptors.request.use((config) => {
  ...
  const bearer =
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6InVzZXIxIiwic3ViIjoxLCJpYXQiOjE3MzkzMTAyMjIsImV4cCI6MTczOTMxMjAyMn0.Un8OLzJN_TukTwtcwCEBVKct_j5PAtiPDJWENAWMXxA'
